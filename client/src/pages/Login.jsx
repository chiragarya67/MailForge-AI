...
const Login = () => {
    ...
    return (
        <div className="relative min-h-screen bg-[#050816] font-sans text-white overflow-hidden flex flex-col justify-center py-12 px-4 sm:px-6">
            ...
            />
            <div
                className="pointer-events-none fixed -top-40 left-1/4 -z-20 h-[36rem] w-[36rem] rounded-full opacity-35 blur-[120px]"
                style={{ background: 'radial-gradient(circle, #4F7CFF 0%, transparent 70%)' }}
            />
            <div
                className="pointer-events-none fixed -bottom-32 right-0 -z-20 h-[32rem] w-[32rem] rounded-full opacity-25 blur-[130px]"
            ...
            <div className="relative z-10 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="rounded-[28px] py-8 px-6 sm:px-10" style={glass}>
                    ...
                    <div className="mt-6 text-center text-sm">
                        <span className="text-[#B6C2E2]">Don't have an account? </span>
                        <Link to="/signup" className="font-medium text-[#4F7CFF] hover:text-[#8B5CF6] transition-colors">
                            Sign up
                        </Link>
                    </div>
                </div>
